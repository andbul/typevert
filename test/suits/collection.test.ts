...
export function suit() {
    it('should map primitives in collections', () => {
        ...
        // Assert
        expect(result).to.have.property("b_number_collection").that.deep.equals([1,2,3])
        expect(result).to.have.property("b_string_collection").that.deep.equals(['1','2','3'])
        expect(result).to.have.property("b_obj_collection").that.deep.equals([{foo: 1},{foo: 2}])
